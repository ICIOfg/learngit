...
{
	log4cpp::OstreamAppender * osAppender1 = new log4cpp::OstreamAppender("osAppender11",&cout);
	osAppender1 -> setLayout(new log4cpp::BasicLayout());

	log4cpp::OstreamAppender * osAppender2 = new log4cpp::OstreamAppender("osAppender12", &cout);
